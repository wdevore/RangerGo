...
func (s *sceneSplash) Draw(context api.IRenderContext) {
	...
	context.DrawLine(500, 500, 100, 50)
	// context.RenderLine(350, 350, 500, 500)
	...
	// min := geometry.NewPointUsing(0.0, 0.0)
	// max := geometry.NewPointUsing(100.0, 100.0)
	// context.RenderAARectangle(min, max, api.FILLED)

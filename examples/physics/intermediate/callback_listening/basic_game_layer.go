...
// Filtering is based on masking bits.
// This is the masking arrangement of this example:
//
//   I am a...          I collide with...
// | Circle           | Rectangle
// | Triangle         | Circle
// | Rectangle        | Circle
...
func (g *gameLayer) Build(world api.IWorld) {
	...
	g.boxComp.Configure(targetSize/2.0, entityRectangle, entityCircle|entityBoundary, &g.b2World)
	g.boxComp.SetPosition(10.0, 0.0)

	g.circleComp = NewCircleComponent("CircleComp", g)
	g.circleComp.Configure(targetSize, entityCircle, entityRectangle|entityTriangle|entityBoundary, &g.b2World)
	g.circleComp.SetPosition(0.0, -20.0)
	...
	g.fenceComp.Configure(entityBoundary, entityTriangle|entityCircle, &g.b2World)
